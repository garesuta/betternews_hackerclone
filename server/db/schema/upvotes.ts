...
export const postUpvotesTable = pgTable("post_upvotes",{
    ...
    ceratedAt: timestamp("created_at",{withTimezone:true}).defaultNow().notNull(), 
})

export const postUpvoteRalations = relations(postUpvotesTable,({one})=>({
    post: one(postsTable,{
...
export const commentUpvoteRalations = relations(commentUpvotesTable,({one})=>({
